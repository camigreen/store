    ...
    <div class="uk-modal-dialog ">
        <div class="uk-vertical-align" style="height:110px">
            <div class="uk-width-1-1 uk-text-center uk-vertical-align-middle ttop-checkout-processing-modal-content">
                ...
                <p class="uk-article-lead uk-text-center">Please be patient....</p>
                <p class="uk-article-lead uk-text-center">Processing your credit card may take up to a minute,</p>
                <p class="uk-article-lead uk-text-center">please do not hit the back button.</p>
            </div>
        </div>
