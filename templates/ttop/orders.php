...
<div class="uk-width-1-1">
	...
	<ul class="uk-pagination">
	    <li><a href="orders/all-orders?limit=10&offset=0"><i class="uk-icon-angle-double-left"></i></a></li>
	    <li class="uk-active"><a href="orders/all-orders?limit=10&offset=0"><span>1</span></a></li>
	    <li><a href="orders/all-orders?limit=10&offset=10"><span>2</span></a></li>
    	<li><a href="orders/all-orders?limit=10&offset=10"><i class="uk-icon-angle-double-right"></i></a></li>
	</ul>
</div>
