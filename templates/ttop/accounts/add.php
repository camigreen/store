<div class="ttop ttop-account-select-type">
	...
	<ul class="uk-grid uk-grid-width-1-4 uk-text-center">
	    ...
	    <li><button class="uk-button uk-button-primary uk-width-1-2" data-type="store.user">Salesman</button></li>
	    <li><button class="uk-button uk-button-primary uk-width-1-2" data-type="dealership.user">Dealer</button></li>
	</ul>
